...
<div class="page-content">
    <div class="wt-bnr-inr overlay-wraper bg-center" style="background-image:url('{{asset('images/'.$cms->image)}}');">
    <!-- <div class="wt-bnr-inr overlay-wraper bg-center" style="background-image:url('{{asset('ajanta-resource/ajanta-resource/images/banner/8.jpg')}}');"> -->
            ...
            <div class="wt-bnr-inr-entry">
                ...
                <div>
                    <ul class="wt-breadcrumb breadcrumb-style-2">
                        ...
                        <li><a href="javascript:void(0);">{{$cms->title}}</a></li>
                    </ul>
                </div>
                <!-- BREADCRUMB ROW END -->
            </div>
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12">
                            ...
                            <div class="blog-post date-style-2">
                                <div class="wt-post-media wt-img-effect zoom-slow">
                                  <img src="{{asset('images/'.$cms->image)}}" alt="{{$cms->title}}">
                                </div>
                                <div class="wt-post-info bg-white p-t30">
                                    <div class="wt-post-meta ">
                                        <ul>
                                            <li class="post-category"><span>{{get_cat($cms->category_ids)->title}}</span> </li>
                                            <li class="post-date">{{date('F d, Y',strtotime($cms->created_at))}}</li>
                                            <!-- <li class="post-comment">24 Comment</li> -->
                                        </ul>
                                    </div>
                                    <div class="wt-post-title ">
                                        <h3 class="post-title">{{$cms->title}}</h3>
                                    </div>
                                    <div class="wt-post-readmore">{!!$cms->description!!}</div>
                                </div>
                            </div>
                                    ...
                                    <div class="widget-post-bx">
                                        <div class="widget-post clearfix">
                                            <div class="wt-post-media">
                                                <img src="{{asset('ajanta-resource/images/blog/recent-blog/pic1.jpg')}}" alt="">
                                            </div>
                                        ...
                                        <div class="widget-post clearfix">
                                            <div class="wt-post-media">
                                                <img src="{{asset('ajanta-resource/images/blog/recent-blog/pic2.jpg')}}" alt="">
                                            </div>
                                            <div class="wt-post-info">
                                                <div class="wt-post-header">
                                        ...
                                        <div class="widget-post clearfix">
                                            <div class="wt-post-media">
                                                <img src="{{asset('ajanta-resource/images/blog/recent-blog/pic3.jpg')}}" alt="">
                                            </div>
                                            <div class="wt-post-info">
                                                <div class="wt-post-header">
